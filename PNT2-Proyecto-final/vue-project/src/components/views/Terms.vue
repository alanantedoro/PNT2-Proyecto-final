	...
	<div class="contenedora">
		...
		<h6>
			...
			<p>
				...
				constructive, or statutory, including, without limitation, any implied
				warranties of merchantability, non-infringement or fitness for a
				particular purpose.
			</p>

			<p>
				UnovaRPG makes no guarantee of availability of service and reserves the
				right to change, withdraw, suspend, or discontinue any functionality or
				feature of the UnovaRPG's services. In no event shall UnovaRPG be liable
				...
				the use of or inability to use the UnovaRPG's services or any content
				thereon. This disclaimer applies, without limitation, to any damages or
				injury, whether for breach of contract, tort, or otherwise, caused by
				...
				corruption; communication-line failure; network or system outage; or
				theft, destruction, unauthorized access to, alteration of, or use of any
				record.
			</p>

			<p>
				User agrees to indemnify and hold UnovaRPG harmless from any loss,
				liability, claims, damages and expenses, including attorneys fees,
				arising from or related to the content, use, or deletion of User's Files
				or use of any other feature or service. This expressly includes:<br />
				- User's responsibility for any and all liability arising from the
				violation or infringement of proprietary rights or copyrights.<br />
				- Any defamatory or unlawful material contained within User's Files.
			</p>

			<p>
				To ensure the privacy of kids, we do not collect any personally
				identifiable information from children under the age of 13. Only a user
				name that they have chosen and information related to the game (such as
				Pokémon they have, badges earned, etc) is available to other members.
			</p>
